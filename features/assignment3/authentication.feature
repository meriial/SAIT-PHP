...
Scenario: User password has only letters
  Given I visit 'assignment3/registration.php'
  ...
  And I press "Submit"
  Then I should be on 'assignment3/registration.php'
...
Scenario: User password is good
  ...
  And I press "Submit"
  Then I should be on 'assignment3/login.php'
...
Scenario: Logged out user cannot access content page
  ...
  When I visit 'assignment3/main.php'
  Then I should be on 'assignment3/login.php'
